...
def login_page():
    ...
    with col1:
        st.markdown("<div style='text-align: center; position: relative; top: 35px; margin-top: -20px;font-weight: bold; '>", unsafe_allow_html=True)
        st.markdown("<h1 style='font-size: 80px; font-weight: bold;'>PishEye</h1>", unsafe_allow_html=True)
        st.markdown("<h5 style='font-size: 36px;'>Think Before You Click</h5>", unsafe_allow_html=True)
        st.markdown("<h5 style='font-size: 36px;'>Stay Safe from Tricks</h5>", unsafe_allow_html=True)
